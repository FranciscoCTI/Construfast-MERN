...
const FilterBar = () => {
    ...
    return (
        <Stack direction={'row'} spacing={4} mb={6}>
            <Select bg={"white"} placeholder="All disciplines" onChange={(e) => setDiscipline(e.target.value)}>
            ...
            <Select bg={"white"} placeholder="All cities" onChange={(e) => setCity(e.target.value)}>
